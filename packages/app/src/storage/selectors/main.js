...
export const getAfterClickPlacemark = selector({
  key: "getAfterClickPlacemark",
  get: ({ get }) => get(_).afterClickPlacemark,
  set: ({ set }, value) =>
    set(_, (state) => ({ ...state, afterClickPlacemark: value })), // setter example
});
...
export const getAfterClickList = selector({
  key: "getAfterClickList",
  get: ({ get }) => get(_).afterClickList,
  set: ({ set }, value) =>
    set(_, (state) => ({ ...state, afterClickList: value })), // setter example
});
...
export const getSelectedVacancyForEdit = selector({
  ...
  get: ({ get }) => get(_).selectedVacancyForEdit,
  set: ({ set }, value) =>
    set(_, (state) => ({ ...state, selectedVacancyForEdit: value })), // setter example
});
...
export const getDropdownOpened = selector({
  key: "getDropdownOpened",
  get: ({ get }) => get(_).dropdownOpened,
  set: ({ set }, value) =>
    set(_, (state) => ({ ...state, dropdownOpened: value })), // setter example
});
